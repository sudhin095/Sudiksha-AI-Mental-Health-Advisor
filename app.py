...
def lexicon_score(text):
    ...
    # Check single keywords with negation window
    ...
    if st.button("🔍 Analyze Stress", use_container_width=True, key="analyze_text"):
        ...
        if not input_text:
            ...
            if elapsed < 5:
                ...
                # Crisis Banner (only for high stress)
                if final_level >= 75:
